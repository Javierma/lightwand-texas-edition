 ...
 */
 ...
 /*  Copyright (C) 2016 Javier Mart�nez Arrieta
 *
...
void sd_startSSI0(void);
void sd_startSSI1(void);
void sd_startSSI2(void);
void sd_startSSI3(void);
...
void read_first_sector(enum SSI);
void read_disk_data(enum SSI);
...
unsigned int rcvr_datablock (unsigned char *buff, unsigned int btr);
